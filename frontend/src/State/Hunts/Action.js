...
import { CREATE_HUNT_FAILURE, CREATE_HUNT_REQUEST, CREATE_HUNT_SUCCESS, FETCH_CLUE_BY_ID_FAILURE, FETCH_CLUE_BY_ID_REQUEST, FETCH_CLUE_BY_ID_SUCCESS, FETCH_HUNT_FAILURE, FETCH_HUNT_REQUEST, FETCH_HUNT_SUCCESS, GET_ALL_HUNTS_BY_ID_FAILURE, GET_ALL_HUNTS_BY_ID_REQUEST, GET_ALL_HUNTS_BY_ID_SUCCESS, GET_ALL_HUNTS_FAILURE, GET_ALL_HUNTS_REQUEST, GET_ALL_HUNTS_SUCCESS, SEARCH_HUNT_FAILURE, SEARCH_HUNT_SUCCESS, SOLVE_CLUE_FAILURE, SOLVE_CLUE_REQUEST, SOLVE_CLUE_SUCCESS, JOIN_HUNT_SUCCESS,
    JOIN_HUNT_ERROR,
    JOIN_HUNT_REQUEST } from './ActionType';
// create hunt
...
export const fetchHuntById=(data)=>async(dispatch)=>{
    ...
    try{
        const response=await axios.get(`http://localhost:5454/hunt/${data}`);
...
export const getAllHunts=(data)=>async(dispatch)=>{
    dispatch({type:GET_ALL_HUNTS_REQUEST});
    try{
        const response=await axios.get('http://locahost:5454/hunt/getAllHunts',data);
